...
labelsU, timeU = readFiles("without_unbalanced.csv")
labelsB, timeB = readFiles("without_balanced.csv")
print(len(labelsU))
print(len(labelsB))
...
ticks = [i + 0.5 for i in range(3, len(labelsU) * 2 + 2, 2)]
ax.set(xticks=ticks, xticklabels=list(range(3, len(labelsU) + 3)))
