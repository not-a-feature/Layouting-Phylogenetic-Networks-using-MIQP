...
settings = {
    ...
    "c_close": 2,  # int, children should be close together
    "p_cent_c": 2,  # int, parents should be centered in between the children
    "max_dist_gc": 1,  # int, maximize the distance of the center of grandchildren
    "hybrid_cent_lcsa": 1,  # int, lowest common stable ancestor centered to hybrid
    "min_direct_crossing": 0,  # int, minimize direct crossings
    "min_hybrid_length": 2,  # int, minimize vertical length of hybrid-edges
    # Solve settings
...
file_names = listdir(in_path)
file_names = natsorted(file_names)[:560]
