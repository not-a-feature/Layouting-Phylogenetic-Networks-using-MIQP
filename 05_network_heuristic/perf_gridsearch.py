...
# Load trees
tree_files = [path.join(basePath, "Trees", f"t{i}.gml") for i in range(500, 600)]
...
time_measurements = {}
for grid_pos in product([True, False], repeat=3):
    ...
    settings["no_direct_crossing"] = grid_pos[2]  # bool, don't allow crossing of edges
